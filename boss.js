        ...
        setMovementBoss(){
            ...
            const idle = this.gameObj.onStateEnter("idle", async (previousState)=>{
                ...
                const attack = this.gameObj.onStateEnter("attack",  async ()=>{
                    ...
                    if (currentTime - this.lastAttackTime >= 10000) {
                        this.lastAttackTime = currentTime; 
                        
                        add([
                            rect(30, 30),
                            area(),
                            pos(vec2(this.gameObj.pos.x - 40, this.gameObj.pos.y + 80)),
                            scale(3),
                            opacity(0),
                            "boss-attack"
                        ]);
                        ...
                        add([
                            rect(30, 30),
                            area(),
                            pos(vec2(this.gameObj.pos.x - 40, this.gameObj.pos.y - 140)),
                            scale(3),
                            opacity(0),
                            "boss-attack"
                        ]);
                        ...
                        add([
                            rect(30, 30),
                            area(),
                            pos(vec2(this.gameObj.pos.x - 160, this.gameObj.pos.y - 20)),
                            scale(3),
                            opacity(0),
                            "boss-attack"
                        ]);
                        ...
                        add([
                            rect(30, 30),
                            area(),
                            pos(vec2(this.gameObj.pos.x + 90, this.gameObj.pos.y - 20)),
                            scale(3),
                            opacity(0),
                            "boss-attack"
                        ]);
                        ...
                        setTimeout(() => {
                            ...
                            console.log("vo voltar")
                            this.gameObj.enterState("follow-player");
                        }, 3000);
                    } else {
                        console.log("vo descansarr")
                        setTimeout(() => {
                            this.gameObj.enterState("follow-player");
                        }, 1000);                    }           
                })
